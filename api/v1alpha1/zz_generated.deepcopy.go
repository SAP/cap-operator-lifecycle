...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientRateLimiting) DeepCopyInto(out *ClientRateLimiting) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientRateLimiting.
func (in *ClientRateLimiting) DeepCopy() *ClientRateLimiting {
	if in == nil {
		return nil
	}
	out := new(ClientRateLimiting)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Controller) DeepCopyInto(out *Controller) {
	*out = *in
	...
	if in.MaxConcurrentReconciles != nil {
		...
		*out = new(MaxConcurrentReconciles)
		**out = **in
	}
	...
	if in.ClientRateLimiting != nil {
		in, out := &in.ClientRateLimiting, &out.ClientRateLimiting
		*out = new(ClientRateLimiting)
		**out = **in
	}
	out.RolloutDelay = in.RolloutDelay
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MaxConcurrentReconciles) DeepCopyInto(out *MaxConcurrentReconciles) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MaxConcurrentReconciles.
func (in *MaxConcurrentReconciles) DeepCopy() *MaxConcurrentReconciles {
	if in == nil {
		return nil
	}
	out := new(MaxConcurrentReconciles)
...
func (in *Monitoring) DeepCopyInto(out *Monitoring) {
	*out = *in
	if in.ServiceMonitorSelectorLabels != nil {
		in, out := &in.ServiceMonitorSelectorLabels, &out.ServiceMonitorSelectorLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
